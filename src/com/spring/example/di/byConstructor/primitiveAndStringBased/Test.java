...
//        BeanFactory factory = new ClassPathXmlApplicationContext("com/spring/example/iocContainers/iocContainer-applcationContext.xml");
        ApplicationContext factory = new ClassPathXmlApplicationContext("com/spring/example/di/byConstructor/primitiveAndStringBased/constructor-di-applcationContext.xml");
